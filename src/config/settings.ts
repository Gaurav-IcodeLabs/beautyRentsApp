...
const appSettings = {
  ...
  dev: process.env.EXPO_PUBLIC_APP_ENV === 'development',
  verbose: false,

  sdk: {
    clientId: process.env.EXPO_PUBLIC_SHARETRIBE_SDK_CLIENT_ID,
    baseUrl: process.env.EXPO_PUBLIC_SDK_BASE_URL,
    assetCdnBaseUrl: process.env.EXPO_PUBLIC_SDK_ASSET_CDN_BASE_URL,
    transitVerbose:
      process.env.EXPO_PUBLIC_SHARETRIBE_SDK_TRANSIT_VERBOSE === 'true',
  },
  ...
  usingSSL: process.env.EXPO_PUBLIC_SHARETRIBE_USING_SSL === 'true',
}
