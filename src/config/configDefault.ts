...
const defaultConfig = {
  ...
  marketplaceRootURL: process.env.REACT_NATIVE_MARKETPLACE_ROOT_URL,
  ...
  marketplaceName: process.env.REACT_NATIVE_MARKETPLACE_NAME || 'Biketribe',
  ...
  facebookAppId: process.env.REACT_NATIVE_FACEBOOK_APP_ID,
