...
const editListingSlice = createSlice({
  ...
  extraReducers: builder => {
    ...
    builder.addCase(
      requestCreateListingDraft.fulfilled,
      (state, { payload }) => {
    ...
    builder.addCase(
      requestCreateListingDraft.rejected,
      (state, { payload }) => {
        state.createListingDraftInProgress = false
    ...
    builder
      .addCase(requestPublishListingDraft.rejected, (state, { payload }) => {
        state.publishDraftInProgress = false
      ...
      .addCase(
        requestAddAvailabilityException.rejected,
        (state, { payload }) => {
          state.addExceptionInProgress = false
      ...
      .addCase(
        requestDeleteAvailabilityException.pending,
        (state, { meta }) => {
...
//Thunks
export const requestShowListing = createAsyncThunk<{}, {}, Thunk>(
  'editListing/requestShowListingStatus',
  async (actionPayload, { dispatch, extra: sdk }) => {
    try {
      const { config, ...rest } = actionPayload
...
export const requestCreateListingDraft = createAsyncThunk<{}, {}, Thunk>(
...
export const requestUpdateListing = createAsyncThunk<{}, {}, Thunk>(
...
export const requestPublishListingDraft = createAsyncThunk<{}, {}, Thunk>(
  'editListing/requestPublishListingDraftStatus',
  async (listingId, { dispatch, extra: sdk }) => {
    try {
      const response = sdk.ownListings.publishDraft(
        { id: listingId },
        { expand: true },
      )
...
export const compareAndSetStock = createAsyncThunk<{}, {}, Thunk>(
