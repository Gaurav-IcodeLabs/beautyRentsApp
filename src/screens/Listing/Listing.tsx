...
export const Listing: React.FC<ListingScreenProps> = props => {
  ...
  const userAndListingAuthorAvailable = !!(currentUserId && authorAvailable);
  const isOwnListing =
    userAndListingAuthorAvailable && listing.author.id.uuid === currentUserId;
    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <ListingImageCarousel
          ...
          totalRatingSum={publicData?.totalRatingSum}
