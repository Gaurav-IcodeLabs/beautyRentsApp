...
export const TermsOfService = () => {
  ...
  useEffect(() => {
    const pageAsset = {
      termsOfService: `content/pages/${AssetNames.TERMS_OF_SERVICE}.json`,
    }
  ...
  const sections =
    pageAssetsData?.[camelize(AssetNames.TERMS_OF_SERVICE)]?.data?.sections ||
    []
  return (
    <View style={styles.container}>
      <ScreenHeader title={t('TermsOfService.title')} />
      <FlashList
